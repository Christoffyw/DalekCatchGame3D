...
public class RenderManager {
    ...
    private final int SHADOW_RES = 2048;
    ...
    public void init() {
        ...
        GL30.glTexImage2D(GL30.GL_TEXTURE_2D, 0, GL30.GL_DEPTH_COMPONENT, SHADOW_RES, SHADOW_RES, 0, GL30.GL_DEPTH_COMPONENT, GL30.GL_FLOAT, MemoryUtil.NULL);
